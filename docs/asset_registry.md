...
| Portrait | Princess portrait (PR-01) | Replaced | `assets/proprietary/production/portraits/princess_portrait_v01.png` | High | Yes | `512x512` painterly, palette-anchored, shoulders-up three-quarters, dark fade background | `autoloads/ActorVisuals.gd`, `data/dialogue/prologue_inciting_incident.json`, `data/dialogue/prologue_unwinnable_fight.json` |
| Portrait | King Aldren portrait (PR-02) | Replaced | `assets/proprietary/production/portraits/king_aldren_portrait_v01.png` | High | Yes | `512x512` painterly, cooler lighting than Princess, ceremonial armor + circlet visible | `autoloads/ActorVisuals.gd`, `data/dialogue/prologue_inciting_incident.json`, `data/dialogue/prologue_unwinnable_fight.json` |
| Portrait | Queen portrait (PR-03) | Replaced | `assets/proprietary/production/portraits/queen_portrait_v01.png` | High | Yes | `512x512` painterly, ambiguous balanced lighting (moral hinge), cream-and-rose-violet gown | `autoloads/ActorVisuals.gd`, `data/dialogue/prologue_inciting_incident.json`, `data/dialogue/prologue_unwinnable_fight.json` |
| Portrait | Captain of the Royal Guard portrait (PR-04) | Replaced | `assets/proprietary/production/portraits/captain_royal_guard_portrait_v01.png` | High | Yes | `512x512` painterly, helmless, low warm candlelight from below, tired expression | `autoloads/ActorVisuals.gd`, `data/dialogue/prologue_unwinnable_fight.json` |
| Battle Sprite | Captain of the Royal Guard battle pose (BS-02) | Replaced | `assets/proprietary/production/sprites/captain_royal_guard_battle_v01.png` | High | Yes | Single-pose painted, facing left (enemy side), drawn longsword low-ready, plate armor + closed helm + cape, transparent bg (pivoted spec — no longer pixel-art 128×160) | `autoloads/ActorVisuals.gd` |
| Battle Sprite | Player Attendant battle pose (BS-01, presented-male) | Replaced | `assets/proprietary/production/sprites/player_attendant_male_battle_v01.png` | High | Yes | Single-pose painted, facing right (player side), defensive forward stance with reverse-grip dagger, muted violet livery, transparent bg (pivoted spec) | `autoloads/ActorVisuals.gd` |
